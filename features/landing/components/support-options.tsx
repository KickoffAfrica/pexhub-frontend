...
">
        ...
        <p className="text-[12px] text-center text-white mt-4">For complaints, send an email to <span className="text-primary-500 font-semibold">helpdesk@faanpexhub.ng</span></p>
        </a>
      </div>
    </div>
        )
